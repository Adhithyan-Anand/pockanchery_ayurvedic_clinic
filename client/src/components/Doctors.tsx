  ...
  const doctors = [
    {
      ...
      image: "https://adhithyaelectronics.in/images/head.jpg",
      moreDetails:
    ...
    },
    {
      ...
      image: "https://adhithyaelectronics.in/images/man.jpg",
      moreDetails: `
...
`
    ...
    },
    {
      ...
      image: "https://adhithyaelectronics.in/images/lady.jpg",
      moreDetails:
        ...
        "<ul class='grid grid-cols-2 gap-x-6 list-disc list-inside mt-2 text-gray-700'>" +
        "<li>Rheumatology</li><li>Gastroenterology</li><li>Urology</li><li>Neurology</li>" +
        "<li>Cardiology</li><li>Pulmonology</li><li>Dermatology</li><li>Endocrinology</li>" +
        "<li>Gynecology</li><li>Lifestyle Disorders</li></ul>"
    }
  ];

        ...
        <div className="container mx-auto px-4 flex justify-between items-center text-sm">
          <div className="flex items-center space-x-4">
            <div>
              ...
              <span className="ml-2"><a href="tel:8893434393" className="hover:underline">+91 88934 34393 (9 PM to 10 PM)</a></span> <span className="ml-2"><a href="tel:9567077650" className="hover:underline">+91 95670 77650 (7AM - 8AM)</a></span> 
